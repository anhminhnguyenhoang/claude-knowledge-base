...
---
Epilogue store path: [epilogue](epilogue.md). Async copy + pipeline: [pipelining-scheduling](pipelining-scheduling.md). LDS swizzle knobs: [knob-catalog-and-sweep](../30-autotuning/knob-catalog-and-sweep.md) (S12.1.F); per-arch LDS table: [target-architecture-gfx950](../60-reference/target-architecture-gfx950.md).
