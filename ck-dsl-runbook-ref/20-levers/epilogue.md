...
---
Epilogue knobs: [knob-catalog-and-sweep](../30-autotuning/knob-catalog-and-sweep.md) (S12.1.E). The cost-moved caveat: [unified-attention-2d](../50-case-studies/unified-attention-2d.md) (S17.4). ISA store-width check: [isa-resource-inspection](isa-resource-inspection.md).
