...
---
Next: [work-decomposition](work-decomposition.md). Per-family variant levers: [knob-catalog-and-sweep](../30-autotuning/knob-catalog-and-sweep.md) (S12.1.A). Op checklists: [op-specific-checklists](../30-autotuning/op-specific-checklists.md).
