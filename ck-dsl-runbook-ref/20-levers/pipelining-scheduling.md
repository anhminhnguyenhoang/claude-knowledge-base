...
---
Pipeline knobs (mem/compv3/compv4): [knob-catalog-and-sweep](../30-autotuning/knob-catalog-and-sweep.md) (S12.1.D). Async DRAM->LDS contract: [memory-hierarchy](memory-hierarchy.md). gfx950 sched-barrier caveat: [target-architecture-gfx950](../60-reference/target-architecture-gfx950.md).
