...
---
The lever sections explained: [algorithmic-mapping](../02-levers/algorithmic-mapping.md) through [isa-resource-inspection](../02-levers/isa-resource-inspection.md). Dispatcher worked example: [unified-attention-2d](../05-case-studies/unified-attention-2d.md) (S17.4). Op checklists: [op-specific-checklists](op-specific-checklists.md).
