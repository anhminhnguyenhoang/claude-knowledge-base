...
---
Each node maps to a lever section in [02-levers/](../02-levers/) or to [dsl-probe-workflow](../01-diagnosis/dsl-probe-workflow.md). Heuristics behind it: [decision-heuristics](../04-failure-reporting/decision-heuristics.md).
