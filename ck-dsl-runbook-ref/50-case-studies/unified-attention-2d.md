...
---
Attention levers: [matrix-instructions](../20-levers/matrix-instructions.md), [memory-hierarchy](../20-levers/memory-hierarchy.md), [pipelining-scheduling](../20-levers/pipelining-scheduling.md). Attention-2D micro-levers: [knob-catalog-and-sweep](../30-autotuning/knob-catalog-and-sweep.md) (S12.1.K). Bug signatures: [failure-modes](../40-failure-reporting/failure-modes.md).
