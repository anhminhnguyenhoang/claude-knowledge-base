...
---
The one-page decision tree: [diagnostic-decision-tree](../60-reference/diagnostic-decision-tree.md). Anti-patterns proven in: [case-studies-overview](../50-case-studies/case-studies-overview.md).
