...
---
Heuristics for fixing each: [decision-heuristics](decision-heuristics.md). Bug signatures in practice: [unified-attention-2d](../50-case-studies/unified-attention-2d.md) (S17.4). Tolerance signatures: [define-the-problem](../10-diagnosis/define-the-problem.md) (S1.4).
