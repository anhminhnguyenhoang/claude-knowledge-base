...
---
Atom selection: [matrix-instructions](../20-levers/matrix-instructions.md). LDS swizzle rule: [memory-hierarchy](../20-levers/memory-hierarchy.md). Chiplet knobs: [knob-catalog-and-sweep](../30-autotuning/knob-catalog-and-sweep.md) (S12.1.L). Hardware baseline cross-checks the MI355X host notes in auto-memory.
