...
---
Prev: [steps-12-14-direct-to-lds](steps-12-14-direct-to-lds.md). Chiplet background: [hipkitten chiplet-scheduling](../../../../hipkitten/10-paper/chiplet-scheduling.md). Outcome: [ceiling-and-followups](../02-conclusion/ceiling-and-followups.md).
