...
---
Cheap-filter rationale: [bottleneck-classification](bottleneck-classification.md) (S3.1b). Probe entries in the knob catalog: [knob-catalog-and-sweep](../30-autotuning/knob-catalog-and-sweep.md) (S12.1.Q). Commands: [reproducible-commands](../00-method/reproducible-commands.md).
