...
---
Then pick a lever family: [algorithmic-mapping](../20-levers/algorithmic-mapping.md), [memory-hierarchy](../20-levers/memory-hierarchy.md). Static probes how-to: [dsl-probe-workflow](dsl-probe-workflow.md). ATT-unavailable fallback worked example: [unified-attention-2d](../50-case-studies/unified-attention-2d.md).
