...
---
Next: [memory-hierarchy](memory-hierarchy.md). MFMA operand layout: [matrix-instructions](matrix-instructions.md). Chiplet knobs: [knob-catalog-and-sweep](../03-autotuning/knob-catalog-and-sweep.md) (S12.1.L); arch caps: [target-architecture-gfx950](../06-reference/target-architecture-gfx950.md).
