...
---
Next: [establish-baselines](establish-baselines.md). Lane-mapping K-pack tolerance bug: [work-decomposition](../02-levers/work-decomposition.md). Spec dataclasses are the contract — see the family tables in [algorithmic-mapping](../02-levers/algorithmic-mapping.md).
