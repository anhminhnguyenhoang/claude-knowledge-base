...
---
Family instance tables: [algorithmic-mapping](../20-levers/algorithmic-mapping.md). Full knob list: [knob-catalog-and-sweep](knob-catalog-and-sweep.md). Failure modes per op: [failure-modes](../40-failure-reporting/failure-modes.md).
