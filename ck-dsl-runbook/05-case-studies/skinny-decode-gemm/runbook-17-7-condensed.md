...
---
This is the condensed form of the full 22-step worked walkthrough in this folder: [skinny-decode-gemm](README.md). DTLA/chiplet knobs: [knob-catalog-and-sweep](../../03-autotuning/knob-catalog-and-sweep.md) (S12.1.F/L).
