...
---
Preshuffle / persistent knobs: [knob-catalog-and-sweep](../03-autotuning/knob-catalog-and-sweep.md) (S12.1.H/I). MoE instances: [algorithmic-mapping](../02-levers/algorithmic-mapping.md) (S4.6). Verify-flag-is-honored discipline: [isa-resource-inspection](../02-levers/isa-resource-inspection.md).
