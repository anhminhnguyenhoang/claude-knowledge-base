...
---
Full atom catalog: [target-architecture-gfx950](../06-reference/target-architecture-gfx950.md) (S21.1). Atom/K-pack knobs: [knob-catalog-and-sweep](../03-autotuning/knob-catalog-and-sweep.md) (S12.1.C). Quantified chain re-pack saving: [unified-attention-2d](../05-case-studies/unified-attention-2d.md) (S17.4).
