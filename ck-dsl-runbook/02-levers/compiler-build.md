...
---
Flag safety table: [knob-catalog-and-sweep](../03-autotuning/knob-catalog-and-sweep.md) (S12.1.M). gfx950 compiler caveats: [target-architecture-gfx950](../06-reference/target-architecture-gfx950.md) (S21.8). Anti-pattern (flags before ISA): [decision-heuristics](../04-failure-reporting/decision-heuristics.md).
